...
root.title('Leos Madlib Game')
Label(root, text= 'Leos Madlib Game \n Have Fun!' , font = 'arial 20 bold').pack()
...
def madlib4():
    ...
    print('When I go to the arcade with my '+plural_noun+' there are lots of games to play. I spend lots of time there with my friends. In the game X-Men you can be different '+plural_noun2+'. The point of the game is to '+verb+' every robot. You also need to save people. Then you can go o the next level. In the game Star Wars, you are Luke Skywalker and you try to destroy every '+noun+'. In a car racing/motorcycle racing game you need to beat every computerized vehicle that you are '+ing_verb+' against. There are a while lot of other cool games. When you play some games you win '+plural_noun3+' for certain scores. Once you are done you can cash in your tickets to get a big +'+noun+'. You can save your '+plural_noun4+' for another time. When I went to this arcade I did not believe how much fun it would be. So far I have had a lot of fun everytime I have been at this arcade!')
...
Button(root, text= 'At the Arcade', font ='arial 15', command = madlib4, bg = 'ghost white').place(x=80, y=300)
